...
ASurvivorProjectCharacter::ASurvivorProjectCharacter()
{
	...
	*/
	...
	InitialCharacterPower = 2000.f;
	CharacterPower = 2000.f;

	/** Set base power level*/
	InitialGunPower = 2000.f;
	GunPower = 2000.f;
}
...
void ASurvivorProjectCharacter::SetupPlayerInputComponent(class UInputComponent* InputComponent)
{
	...
	InputComponent->BindAction("Collect", IE_Pressed, this, &ASurvivorProjectCharacter::CollectPickups);
}
